...
const { SIGNIFICANT_EFFECTS_ON_SPECIAL_AREA, SSSI_CHECK, DESIGNATED_SITE_START } = conservationConsiderationURIs
...
export const completion = async request => ['NO', 'NO-ADVICE'].includes(request.payload.effects) ? SSSI_CHECK.uri : DESIGNATED_SITE_START.uri
