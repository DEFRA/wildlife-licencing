...
import Joi from 'joi'
import { getApplicationData, licenceStatuses, checkData, findLastLicenseAnnotation } from './application-common-functions.js'
...
export const getData = async request => {
  ...
  licences.forEach(licence => {
    Object.assign(licence, { lastSent: timestampFormatter(findLastLicenseAnnotation(licence)?.modifiedOn) })
  ...
  const lastSentEventFlag = licences.length > 0 && !!findLastLicenseAnnotation(licences[0])
