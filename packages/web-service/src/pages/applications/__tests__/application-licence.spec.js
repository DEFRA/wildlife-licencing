describe('application-licence page', () => {
  ...
  describe('checkData', () => {
    it('returns null if an applicationId is provided and belongs to the user', async () => {
      ...
      const { checkData } = await import('../application-licence.js')
  ...
  describe('send events', () => {
    it('findLastSentEvent sorts the send events correctly', async () => {
      const { findLastSentEvent } = await import('../application-licence.js')
  ...
  describe('statues', () => {
    it('are as expected', async () => {
      const { statuses } = await import('../application-licence.js')
