...
export const FILE_UPLOAD_HEADROOM_BYTES = parseInt(process.env.FILE_UPLOAD_HEADROOM_BYTES || 10) * 1024 * 1024

export const TIMEOUT_MS = parseInt(process.env.MAX_FILE_UPLOAD_TIMEOUT_MS || 60000)
