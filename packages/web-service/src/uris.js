...
export const NSIP = { uri: '/nationally-significant-infrastructure-project', page: 'nationally-significant-infrastructure-project' }
...
export const ecologistExperienceURIs = {
  ...
  PREVIOUS_INDIVIDUAL_BADGER_LICENCE_DETAILS: { uri: '/previous-individual-badger-licence-details', page: 'previous-individual-badger-licence-details' },
...
export const siteURIs = {
  ...
  UPLOAD_MAP: { uri: '/upload-survey-map', page: 'upload-survey-map' },
...
export const ReturnsURIs = {
  DID_YOU_CARRY_OUT_LICENSED_ACTIONS: { uri: '/did-you-carry-out-licensed-actions', page: 'did-you-carry-out-licensed-actions' },
  OUTCOME: { uri: '/outcome', page: 'outcome' },
  WHY_NIL: { uri: '/reason-actions-not-done', page: 'reason-actions-not-done' },
  ...
  A24: {
    ...
    WHY_NOT_COMPLETE_WITHIN_DATES: { uri: '/why-work-not-completed-within-licence-dates', page: 'why-work-not-completed-within-licence-dates' },
    WELFARE_CONCERNS: { uri: '/licensed-activity-cause-welfare-concerns', page: 'licensed-activity-cause-welfare-concerns' }
  }
}
