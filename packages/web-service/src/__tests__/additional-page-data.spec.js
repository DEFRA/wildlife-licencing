  ...
  it('return response-toolkit continue', async () => {
    ...
    expect(request.response.source.context).toEqual({
      _uri: {
        ...
        invoiceResponsible: '/invoice-payer-responsibility',
        invoiceAddress: '/invoice-address',
        invoiceEmail: '/invoice-payer-email',
        invoiceIsOrganisation: '/invoice-payer-organisation',
        invoiceName: '/invoice-name',
        invoicePostcode: '/invoice-payer-postcode',
        landowner: '/landowner',
        ...
        purchaseOrderReference: '/enter-invoice-reference-purchase-order',
