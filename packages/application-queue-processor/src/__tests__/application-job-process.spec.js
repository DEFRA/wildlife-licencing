...
describe('The application job processor', () => {
  ...
  describe('The buildApiObject function - creates a data and keys payload for the batch update process', () => {
    ...
    it('correctly creates an application with previous licences', async () => {
      jest.doMock('@defra/wls-database-model', () => ({
        models: {
          applications: {
            findByPk: jest.fn(() => ({
          ...
          previousLicences: {
            findAll: jest.fn(() => [{
              ...
              licence: { licenceDetails: 'A1234' },
              sddsPreviousLicenceId: 'd1847e67-07fa-4c51-af03-cb51f5126939'
            }])
          },
          applicationSites: { findAll: jest.fn(() => []) },
