describe('The reference data extract processor: processor', () => {
  afterAll(done => {
    jest.clearAllMocks()
    done()
  })
  ...
  it('runs initialisation', done => {
    jest.isolateModules(() => {
      try {
        ...
        const { applicationPurposesReadStream, applicationTypesReadStream } = require('@defra/wls-powerapps-lib')
        ...
        applicationPurposesReadStream.mockImplementation(() => ({}))
        applicationTypesReadStream.mockImplementation(() => ({}))
