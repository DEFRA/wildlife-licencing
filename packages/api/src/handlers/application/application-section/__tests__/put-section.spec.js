...
describe('put-section-handler', () => {
  ...
  it('returns a 200 response on a successful update, with a key function', async () => {
    ...
    expect(h.response).toHaveBeenCalledWith({
      foo: 'bar',
      a: '2ffae0ad-9d61-4b7c-b4d0-73ce828d9064'
    })
  ...
  it('returns a 200 response on a successful update, with a key function, existing key', async () => {
        ...
        applications: {
          findByPk: jest.fn(() => ({
            dataValues: {
              ...
              targetKeys: [
                {
                  apiBasePath: 'application.section-name',
    ...
    await putSectionHandler(
      'section-name',
      () => 'c9f70b15-15d5-ec11-a7b5-0022481a8a39',
      mockSddsRemoveKeyFunction,
      () => ({ a: 'c9f70b15-15d5-ec11-a7b5-0022481a8a39' })
    )(context, request, h)
    expect(h.response).toHaveBeenCalledWith({
      foo: 'bar',
      a: 'c9f70b15-15d5-ec11-a7b5-0022481a8a39'
