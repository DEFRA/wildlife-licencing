...
let models
let getPreviousLicence
let cache
const applicationJson = 'application/json'

describe('The getPreviousLicence handler', () => {
  beforeAll(async () => {
    models = (await import('@defra/wls-database-model')).models
    getPreviousLicence = (await import('../get-previous-licence.js')).default
  ...
  it('returns a 404 on previous licence not found', async () => {
    models.applications = {
